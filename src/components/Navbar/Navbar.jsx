...
const Navbar = () => {
  ...
  return (
    <div className="fixed app__flex flex-col md:flex-row bg-white min-h-20 w-full z-[999]">
      <div className="flex items-center justify-between md:justify-center w-full lg:basis-11/12 md:basis-10/12 px-4">
      ...
      <button onClick={goToAboutSection} className="w-full py-4 md:h-20 md:basis-2/12 lg:basis-1/12 bg-[#fcbe27] hover:bg-[#fcc027ce] ease-in duration-300 font-bold text-xl md:text-2xl text-white">
        Donate
      </button>
    </div>
  )
